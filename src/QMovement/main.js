...
(function () {
  ...
  Box_Collider.prototype.initialize = function (
    width,
    height,
    ox,
    oy,
  ...
  Box_Collider.prototype.initMembers = function (
    width,
    height,
    ox,
    oy,
...
(function () {
  ...
  Game_Map.prototype.roundPX = function (x) {
    return this.isLoopHorizontal()
      ? x.mod(this.width() * QMovement.tileSize)
      : x;
  };

  Game_Map.prototype.roundPY = function (y) {
    return this.isLoopVertical()
      ? y.mod(this.height() * QMovement.tileSize)
      : y;
  };
...
(function () {
  ...
  Game_CharacterBase.prototype.collisionCheck = function (
    x,
    y,
    dir,
    dist,
...
(function () {
  ...
  Game_Character.prototype.turnTowardCharacterForward = function (
    character,
    dt
  ) {
  ...
  Game_Player.prototype.triggerTouchAction = function () {
    if ($gameTemp.isDestinationValid()) {
      ...
      if (dist <= QMovement.tileSize * 1.5) {
        ...
        var x1 = $gameMap.roundPXWithDirection(
          this._px,
          horz,
          this.moveTiles()
        );
        var y1 = $gameMap.roundPYWithDirection(
          this._py,
          vert,
          this.moveTiles()
        );
...
(function () {
  ...
  Game_Event.prototype.ignoreCharacters = function (type) {
    var ignores = Game_CharacterBase.prototype.ignoreCharacters.call(
      this,
      type
    );
