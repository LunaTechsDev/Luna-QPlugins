...
(function () {
  var _PARAMS = QPlus.getParams("<Luna_QMCollisionMap>", true);
  ...
  Game_Map.prototype.collisionMapPass = function (
    collider,
    dir,
    passableColors
  ) {
  ...
  Game_Map.prototype.collisionMapPolyPass = function (
    ...
    if (dir === "top" || dir === "bottom") {
      var startPoint = this.collisionMapPoints(
        collider,
        dir,
        collider._xMin,
        0
  ...
  Game_Map.prototype.collisionMapPoints = function (
    collider,
    dir,
    value,
    axis
